...
class UserClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.UserTokenReply> login(
  ...
  $grpc.ResponseFuture<$0.UserFullReply> update(
...
class FriendClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.UserFullReply> follow(
    $3.FriendRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$follow, request, options: options);
  }

  $grpc.ResponseFuture<$0.UserFullReply> unfollow(
    $3.FriendRequest request, {
    $grpc.CallOptions? options,
  }) {
...
class MangaClient extends $grpc.Client {
  ...
  MangaClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$4.MangaReply> create(
    $4.MangaRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$create, request, options: options);
  }

  $grpc.ResponseStream<$4.MangaReply> createMany(
    $4.MangasRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$4.MangaReply> findOrCreate(
    $4.MangaRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Id = manga_source_id. Kicks off (or resumes) a throttled background
  /// walk that downloads every not-yet-`done` page of every chapter of
  /// that source.
  $grpc.ResponseFuture<$1.Empty> backfillImages(
    $1.Id request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Id = manga_source_id (see BackfillImages). Cheap `GROUP BY status`
  /// count, meant to be polled on the client's own schedule -- no
  /// long-lived streaming RPC for a job that can run for hours.
  ...
  static final _$setPrimarySource =
      $grpc.ClientMethod<$4.SetPrimarySourceRequest, $4.MangaReply>(
          ...
          $4.MangaReply.fromBuffer);
  static final _$backfillImages = $grpc.ClientMethod<$1.Id, $1.Empty>(
      '/rumgap.v1.Manga/BackfillImages',
      ($1.Id value) => value.writeToBuffer(),
      $1.Empty.fromBuffer);
  static final _$getBackfillStatus =
      $grpc.ClientMethod<$1.Id, $4.BackfillStatusReply>(
...
abstract class MangaServiceBase extends $grpc.Service {
  ...
  MangaServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.Id, $1.Empty>(
        ...
        ($core.List<$core.int> value) => $1.Id.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.Id, $4.BackfillStatusReply>(
        'GetBackfillStatus',
  ...
  $async.Stream<$4.MangaReply> createMany_Pre($grpc.ServiceCall $call,
      $async.Future<$4.MangasRequest> $request) async* {
  ...
  $async.Future<$1.Empty> backfillImages_Pre(
      $grpc.ServiceCall $call, $async.Future<$1.Id> $request) async {
    return backfillImages($call, await $request);
  }

  $async.Future<$1.Empty> backfillImages($grpc.ServiceCall call, $1.Id request);
...
class ChapterClient extends $grpc.Client {
  ...
  ChapterClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$5.ChapterReply> get(
    $5.ChapterRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$get, request, options: options);
  }

  $grpc.ResponseFuture<$5.ChaptersReply> index(
    $5.PaginateChapterQuery request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$index, request, options: options);
  }

  /// Id = chapter_id. Never blocks on downloads -- ensures `chapter_image`
  /// rows exist and returns deterministic local image-server URLs; the
  /// actual download happens lazily on first real request to that URL.
  ...
  /// Id = chapter_id. Manual-only force-refresh: deletes this chapter's
  /// existing `chapter_image` rows (and their stored bytes) and re-scrapes
  ...
  static final _$findEquivalent =
      $grpc.ClientMethod<$5.FindEquivalentRequest, $5.ChapterReply>(
          ...
          $5.ChapterReply.fromBuffer);
  static final _$refreshImages = $grpc.ClientMethod<$1.Id, $5.ImagesReply>(
...
abstract class ChapterServiceBase extends $grpc.Service {
  ...
  $async.Future<$5.ChapterReply> get_Pre($grpc.ServiceCall $call,
      $async.Future<$5.ChapterRequest> $request) async {
    return get($call, await $request);
  }
  ...
  $async.Future<$5.ImagesReply> refreshImages_Pre(
      $grpc.ServiceCall $call, $async.Future<$1.Id> $request) async {
...
class ReadingClient extends $grpc.Client {
  ...
  ReadingClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$4.MangaReply> update(
    $6.ReadingPatchRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$update, request, options: options);
  }
...
class SearchClient extends $grpc.Client {
  ...
  SearchClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$7.SearchReply> manga(
    $7.SearchRequest request, {
    $grpc.CallOptions? options,
  }) {
...
class MetaClient extends $grpc.Client {
  ...
  MetaClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$8.MetaReply> hostnames(
    $8.MetaHostnamesRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$hostnames, request, options: options);
  }

  $grpc.ResponseFuture<$8.MetaReply> genres(
    $8.MetaGenresRequest request, {
    $grpc.CallOptions? options,
  }) {
